...
export default function Dropdown({ question, updateQuestion }: DropdownProps) {
                        ...
                        onChange={(e) =>
                          updateQuestion({
                            options: question.options?.map((opt, idx) =>
                              idx === index
                                ? { ...opt, text: e.target.value, value: e.target.value, isValid: e.target.value.length > 0 }
                                : opt
                            ),
                          })
                        }
